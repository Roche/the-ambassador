...
import pl.filipowm.opensource.ambassador.storage.jooq.Json
import pl.filipowm.opensource.ambassador.storage.jooq.tables.Project.PROJECT
import pl.filipowm.opensource.ambassador.storage.jooq.tables.records.ProjectRecord
    ...
    fun mapper(): RecordMapper<ProjectRecord, ProjectEntity> {
        return RecordMapper {
            ProjectEntity(
                ...
                it.name,
                it.excerpt,
                objectMapper.readValue(it.project.data(), pl.filipowm.opensource.ambassador.model.Project::class.java),
                it.stars,
