...
import com.filipowm.gitlab.api.utils.*
...
abstract class Api(val basePath: String, val client: HttpClient) {
    ...
    protected suspend inline fun <reified T> doPost(
        path: String = "", body: T, params: Map<String, Any?> = mapOf(), headers: Map<String, Any?> = mapOf(), contentType: ContentType = ContentType.Application.Json
    ): T {
    ...
    protected suspend inline fun <reified T> doPut(
        path: String = "", params: Map<String, Any?> = mapOf(), headers: Map<String, Any?> = mapOf(), contentType: ContentType = ContentType.Application.Json
    ): T {
